...
RE2C = exit 0;
AWK = nawk
DATA_TYPES_API_SHARED_LIBADD = -lstdc++
shared_objects_data_types_api = src/classes/arraylist.lo src/classes/linkedlist.lo src/classes/doublylinkedlist.lo src/classes/zend_list.lo src/classes/zend_interface.lo data_types_api.lo
PHP_PECL_EXTENSION = data_types_api
PHP_MODULES = $(phplibdir)/data_types_api.la
PHP_ZEND_EX =
...
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
CPPFLAGS = -I/usr/include/php5 -I/usr/include/php5/main -I/usr/include/php5/TSRM -I/usr/include/php5/Zend -I/usr/include/php5/ext -I/usr/include/php5/ext/date/lib -std=c++11 -DHAVE_CONFIG_H
CXX = g++
CXXFLAGS = -g -O2
...
./data_types_api.la: $(shared_objects_data_types_api) $(DATA_TYPES_API_SHARED_DEPENDENCIES)
	$(LIBTOOL) --mode=link $(CC) $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS) -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_data_types_api) $(DATA_TYPES_API_SHARED_LIBADD)
